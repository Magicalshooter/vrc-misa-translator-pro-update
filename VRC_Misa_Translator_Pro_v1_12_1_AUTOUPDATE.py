...
UI_TEXT = {
    "日本語": {
        ...
        "device_cpu": "CPU",
        "device_gpu": "GPU(cuda)",
        "model_tiny_label": "tiny",
        "model_base_label": "base",
        "model_small_label": "small",
        "model_medium_label": "medium",
        "model_large_v3_label": "large-v3",
        "model_large_v3_turbo_label": "large-v3-turbo",
        ...
        "chatgpt_note": "文体調整はChatGPT翻訳時のみ有効です",
        "chatgpt_key_required": "有効なOpenAI API Keyを入力してください。",
        ...
        "model_hint_tiny": "最も軽いモデルですが、精度は控えめです。",
        "model_hint_small": "高精度ですが、少し重くなります。",
        "model_hint_medium": "かなり高精度ですが、重くなります。",
        ...
        "model_hint_large": "最高精度ですがかなり重く、高性能PC向けです。",
        "model_hint_turbo": "高速かつ高精度。GPU環境で最もバランスが良いモデルです。",
        "model_hint_large_v3": "最高精度モデルです。VRAMを多く使用します。GPU環境での使用を推奨します。",
        "model_hint_large_v3_turbo": "高速かつ高精度な上位モデルです。GPU環境で最もバランスが良いモデルです。",
        "heavy_model_warning_medium": "medium はかなり高精度ですが重く、初回ダウンロードにも時間がかかります。",
        "heavy_model_warning_large": "large は最高精度ですがかなり重く、初回ダウンロードにも時間がかかります。高性能PC向けです。",
        "heavy_model_warning_large_v3": "large-v3 は最高精度ですが非常に重く、GPUと高VRAM環境向けです。初回ダウンロードにも時間がかかります。",
        "heavy_model_warning_large_v3_turbo": "large-v3-turbo は高速・高精度ですが、GPUとVRAMを多く使用します。初回ダウンロードにも時間がかかります。",
        "model_vram_tiny": "VRAM目安: 1GB未満",
        "model_vram_base": "VRAM目安: 1GB前後",
        "model_vram_small": "VRAM目安: 2GB前後",
        "model_vram_medium": "VRAM目安: 5GB前後",
        "model_vram_large": "VRAM目安: 10GB前後",
        "model_vram_large_v3": "VRAM目安: 10GB以上",
        "model_vram_large_v3_turbo": "VRAM目安: 6GB以上",
        "log_filter": "ログ表示",
        "log_filter_all": "すべて",
...
※ 文体調整はChatGPT翻訳時のみ有効です。""",
        ...
        "update_not_configured": "更新URLが未設定です",
        "update_available": "更新があります（{version}）",
        "update_available_notes": "更新があります（{version}） - {notes}",
        "already_latest": "最新の状態です",
        "update_error": "更新確認に失敗しました（{error}）",
        "update_download_start": "更新をダウンロード中…",
        "update_downloaded": "ダウンロードが完了しました",
        "update_ready_restart": "更新を適用しました。再起動してください。",
        "update_not_supported": "この形式では自動適用に対応していません",
        "update_applied_message": "更新を適用しました。アプリを再起動してください。",
        "turbo_warning_title": "Turboモードの警告",
        "turbo_warning_message": "Turbo（高精度 / 高負荷）はVRAMを多く使用します。\n\n人数の多いワールドや重い環境では不安定になる場合があります。\n通常利用ではbaseを推奨します。\n\nTurboは軽い環境でのみ使用してください。",
        "save_runtime_preset": "現在の設定を保存",
        "load_runtime_preset": "保存した設定を読み込み",
        "delete_model": "モデル削除",
        "open_log_folder": "ログフォルダ",
        "advanced_settings": "詳細設定",
        "guide_button": "ガイド",
        ...
        "chatgpt_cost_label": "使用金額",
        "today_short": "今日",
        "update_confirm_install": "インストーラーをダウンロードして更新しますか？",
        "update_title": "アップデート",
        "update_available_button": "更新あり！",
    },
    "English": {
        "app_title": APP_NAME,
        "settings": "Settings",
        ...
        "model_hint_tiny": "The lightest model, but less accurate.",
        "model_hint_small": "More accurate, but slightly heavier.",
        "model_hint_medium": "Very accurate, but heavier.",
        "model_hint_base_cpu": "For general use, base is stable and recommended.",
        ...
        "model_hint_large": "Highest accuracy, but very heavy. Recommended for high-end PCs.",
        "model_hint_large_v3": "Highest accuracy model. Uses a lot of VRAM. Recommended for GPU environments.",
        "model_hint_large_v3_turbo": "Fast and highly accurate model. Best balanced option for GPU environments.",
        "heavy_model_warning_medium": "medium is very accurate, but it is heavy and the first download may take a while.",
        "heavy_model_warning_large": "large has the highest accuracy, but it is very heavy and the first download may take a while. Recommended for high-end PCs.",
        "heavy_model_warning_large_v3": "large-v3 has the highest accuracy, but it is very heavy and recommended for high-VRAM GPU environments. The first download may take a while.",
        "heavy_model_warning_large_v3_turbo": "large-v3-turbo is fast and highly accurate, but it uses GPU and VRAM heavily. The first download may take a while.",
        "model_vram_tiny": "VRAM estimate: under 1GB",
        "model_vram_base": "VRAM estimate: around 1GB",
        "model_vram_small": "VRAM estimate: around 2GB",
        "model_vram_medium": "VRAM estimate: around 5GB",
        "model_vram_large": "VRAM estimate: around 10GB",
        "model_vram_large_v3": "VRAM estimate: 10GB or more",
        "model_vram_large_v3_turbo": "VRAM estimate: 6GB or more",
        "log_filter": "Log View",
        "log_filter_all": "All",
        ...
        "update_confirm_install": "Download the installer and update now?",
        "update_title": "Update",
...
Style adjustment works only during ChatGPT translation.""",
        ...
        "popup_enable": "Show popup",
        "cost_sound_volume": "Alert volume",
        "cost_sound_enable": "Enable alert sound",
        "cost_sound_enabled": "Alert sound",
    ...
    "繁體中文": {
        ...
        "update_confirm_install": "要下載安裝程式並進行更新嗎？",
        "update_title": "更新",
        "update_available_button": "有更新！",
    },
    "简体中文": {
        "app_title": APP_NAME,
        "settings": "设置",
        ...
        "update_confirm_install": "是否下载安装程序并进行更新？",
        "update_title": "更新",
        "update_available_button": "有更新！",
    },
    "한국어": {
        ...
        "update_confirm_install": "설치 파일을 다운로드하여 업데이트하시겠습니까?",
        "update_title": "업데이트",
        "update_available_button": "업데이트 있음"
    },
    "Français": {
        "app_title": APP_NAME,
        "settings": "Paramètres",
...
UI_TEXT.setdefault("繁體中文", {}).update(
    {
        ...
        "translation_mode_chatgpt": "ChatGPT（自然）",
        "model_hint_selected": "選擇模型: {model}",
        "model_hint_tiny": "最輕量的模型，但精度較低。",
        "model_hint_small": "精度較高，但會稍微增加負載。",
        "model_hint_medium": "精度相當高，但較為耗資源。",
        "model_hint_base_cpu": "一般使用 base 較穩定，建議優先使用。",
        "model_hint_tiny": "最輕量的模型，但精度較低。",
        "model_hint_small": "精度較高，但會稍微增加負載。",
        "model_hint_medium": "精度相當高，但資源消耗較多。",
        "model_hint_turbo": "高精度・高負載模式。建議在較輕的環境使用。",
        "model_hint_turbo_gpu": "可使用 GPU。一般使用建議 base，較輕環境可使用 turbo。",
        "model_hint_base_cpu": "一般使用 base 較穩定，建議優先使用。",
        "model_hint_large": "最高精度，但非常耗資源，建議在高性能電腦上使用。",
        "model_hint_large_v3": "最高精度模型。會使用大量VRAM，建議在GPU環境下使用。",
        "model_hint_large_v3_turbo": "高速且高精度的進階模型。在GPU環境中具有最佳平衡。",
        "heavy_model_warning_medium": "medium 精度相當高，但較為耗資源，初次下載可能需要一些時間。",
        "heavy_model_warning_large": "large 具有最高精度，但非常耗資源，初次下載可能需要較長時間。建議在高效能電腦上使用。",
        "heavy_model_warning_large_v3": "large-v3 具有最高精度，但非常耗資源，建議在高 VRAM 的 GPU 環境下使用。初次下載可能需要較長時間。",
        "heavy_model_warning_large_v3_turbo": "large-v3-turbo 兼具高速與高精度，但會大量使用 GPU 和 VRAM，初次下載可能需要一些時間。",
        "model_vram_tiny": "VRAM 建議: 1GB 以下",
        "model_vram_base": "VRAM 建議: 約 1GB",
        "model_vram_small": "VRAM 建議: 約 2GB",
        "model_vram_medium": "VRAM 建議: 約 5GB",
        "model_vram_large": "VRAM 建議: 約 10GB",
        "model_vram_large_v3": "VRAM 建議: 10GB 以上",
        "model_vram_large_v3_turbo": "VRAM 建議: 6GB 以上",
        "log_filter": "日誌顯示",
        "log_filter_all": "全部",
...
UI_TEXT.setdefault("简体中文", {}).update(
    {
        ...
        "translation_mode_chatgpt": "ChatGPT（自然）",
        "model_hint_selected": "当前选择: {model}",
        "model_hint_tiny": "最轻量的模型，但精度较低。",
        "model_hint_small": "精度较高，但会稍微增加负载。",
        "model_hint_medium": "精度较高，但资源占用也更高。",
        "model_hint_turbo": "高精度、高负载模式。建议在较轻的环境下使用。",
        "model_hint_turbo_gpu": "可使用 GPU。一般建议使用 base，在较轻环境下可使用 turbo。",
        "model_hint_base_cpu": "日常使用 base 更稳定，建议优先选择。",
        "model_hint_large": "最高精度，但资源占用很高，建议在高性能电脑上使用。",
        "model_hint_large_v3": "最高精度模型，会占用较多 VRAM，建议在 GPU 环境下使用。",
        "model_hint_large_v3_turbo": "高速且高精度的高级模型，在 GPU 环境下具有最佳平衡。",
        "heavy_model_warning_medium": "medium 精度较高，但资源占用较大，首次下载可能需要一些时间。",
        "heavy_model_warning_large": "large 具有最高精度，但资源占用很高，首次下载可能需要较长时间。建议在高性能电脑上使用。",
        "heavy_model_warning_large_v3": "large-v3 具有最高精度，但资源占用很高，建议在高 VRAM 的 GPU 环境下使用。首次下载可能需要较长时间。",
        "heavy_model_warning_large_v3_turbo": "large-v3-turbo 兼具高速和高精度，但会大量使用 GPU 和 VRAM，首次下载可能需要一些时间。",
        "model_vram_tiny": "VRAM 建议: 1GB 以下",
        "model_vram_base": "VRAM 建议: 约 1GB",
        "model_vram_small": "VRAM 建议: 约 2GB",
        "model_vram_medium": "VRAM 建议: 约 5GB",
        "model_vram_large": "VRAM 建议: 约 10GB",
        "model_vram_large_v3": "VRAM 建议: 10GB 以上",
        "model_vram_large_v3_turbo": "VRAM 建议: 6GB 以上",
        "log_filter": "日志显示",
        "log_filter_all": "全部",
        "log_filter_error": "僅錯誤",
        "log_filter_warn": "僅警告",
...
UI_TEXT.setdefault("한국어", {}).update(
    {
        ...
        "model_large_v3_label": "large-v3",
        "model_large_v3_turbo_label": "large-v3-turbo",
        "heavy_model_warning_medium": "medium은 정확도가 높지만 무겁고, 처음 다운로드에 시간이 걸릴 수 있습니다.",
        "heavy_model_warning_large": "large는 최고 정확도를 제공하지만 매우 무겁고, 처음 다운로드에 시간이 걸릴 수 있습니다. 고성능 PC에서 사용을 권장합니다.",
        "heavy_model_warning_large_v3": "large-v3는 최고 정확도를 제공하지만 매우 무겁고, 고 VRAM GPU 환경에서 사용을 권장합니다. 처음 다운로드에 시간이 걸릴 수 있습니다.",
        "heavy_model_warning_large_v3_turbo": "large-v3-turbo는 빠르고 정확하지만 GPU와 VRAM을 많이 사용하며, 처음 다운로드에 시간이 걸릴 수 있습니다.",
        ...
        "model_hint_selected": "선택됨: {model}",
        "model_hint_tiny": "가장 가벼운 모델이지만 정확도는 낮습니다.",
        "model_hint_small": "정확도가 더 높지만 약간 더 무겁습니다.",
        "model_hint_medium": "정확도가 상당히 높지만 더 많은 자원을 사용합니다.",
        "model_hint_turbo": "고정확도, 고부하 모드입니다. 가벼운 환경에서 사용하는 것을 권장합니다.",
        "model_hint_turbo_gpu": "GPU를 사용할 수 있습니다. 일반적인 사용에는 base를 권장하며, 가벼운 환경에서는 turbo도 사용할 수 있습니다.",
        "model_hint_base_cpu": "일반적인 사용에는 base가 안정적이므로 권장됩니다.",
        "model_hint_large": "최고 정확도이지만 매우 무겁고, 고성능 PC에서 사용을 권장합니다.",
        "model_hint_large_v3": "최고 정확도의 모델입니다. VRAM을 많이 사용하므로 GPU 환경에서 사용하는 것을 권장합니다.",
        "model_hint_large_v3_turbo": "고속이면서 높은 정확도의 상위 모델입니다. GPU 환경에서 가장 균형 잡힌 모델입니다.",
        "model_vram_tiny": "VRAM 권장: 1GB 미만",
        "model_vram_base": "VRAM 권장: 약 1GB",
        "model_vram_small": "VRAM 권장: 약 2GB",
        "model_vram_medium": "VRAM 권장: 약 5GB",
        "model_vram_large": "VRAM 권장: 약 10GB",
        "model_vram_large_v3": "VRAM 권장: 10GB 이상",
        "model_vram_large_v3_turbo": "VRAM 권장: 6GB 이상",
        "log_filter": "로그 표시",
        "log_filter_all": "전체",
...
UPDATE_INFO_URL = (
    "https://magicalshooter.github.io/vrc-misa-translator-pro-update/update.json"
)
...
class VRChatTranslatorGUI:
    ...
    def update_model_list(self):
        device_value = str(self.compute_device.get()).lower()
        resolved = str(getattr(self, "resolved_compute_device", "")).upper()

        is_gpu = (
            resolved == "GPU"
            or "gpu" in device_value
            or "cuda" in device_value
        )

        if is_gpu:
            model_list = ["tiny", "base", "small", "medium", "large", "large-v3", "large-v3-turbo"]
        else:
    ...
    def refresh_update_button_text(self):
        try:
            if not hasattr(self, "btn_check_updates"):
                return

            if getattr(self, "update_available", False):
                self.btn_check_updates.configure(text=self.tr("update_available_button"))
            else:
                self.btn_check_updates.configure(text=self.tr("update_button_short"))
        except Exception:
            pass

    def load_blacklist_phrases(self):
        try:
            if BLACKLIST_FILE.exists():
                lines = BLACKLIST_FILE.read_text(encoding="utf-8").splitlines()
                items = [line.strip() for line in lines if line.strip()]
                if items:
                    self.log(f"Blacklist file: {BLACKLIST_FILE}")
                    return items
        except Exception as e:
            self.log(f"Failed to load blacklist.txt: {e}")

        items = list(DEFAULT_BLACKLIST_PHRASES)
    ...
    def save_blacklist_phrases_to_file(self):
        try:
            BLACKLIST_FILE.parent.mkdir(parents=True, exist_ok=True)
            BLACKLIST_FILE.write_text(
            ...
            self.log(f"Blacklist saved: {BLACKLIST_FILE}")
        except Exception as e:
            self.log(f"Failed to save blacklist.txt: {e}")
    ...
    def __init__(self, root):
        ...
        self.compute_device.trace_add("write", lambda *args: self.update_model_list())
        ...
        self._toast_windows = []
        self.blacklist_phrases = self.load_blacklist_phrases()
        ...
        self.root.after(3000, self._startup_update_check)
    ...
    def on_model_changed(self, event=None):
        ...
        if (
            selected in {"medium", "large", "large-v3", "large-v3-turbo"}
            and selected not in self._warned_heavy_models
        ):
            self._warned_heavy_models.add(selected)
            try:
                if selected == "medium":
                    msg = self.tr("heavy_model_warning_medium")
                elif selected == "large":
                    msg = self.tr("heavy_model_warning_large")
                elif selected == "large-v3":
                    msg = self.tr("heavy_model_warning_large_v3")
                elif selected == "large-v3-turbo":
                    msg = self.tr("heavy_model_warning_large_v3_turbo")
                else:
                    msg = self.tr("heavy_model_warning_large")
    ...
    def update_model_guidance_text(self):
        ...
        if selected in ("large-v3", "large-v3-turbo"):
            if getattr(self, "resolved_compute_device", "CPU") != "GPU":
                self.model_guidance_text.set("このモデルはGPU推奨です。CPUでは非常に重くなる可能性があります。")
            elif selected == "large-v3":
                self.model_guidance_text.set(
                    f"{self.tr('model_hint_large_v3')} / {self.tr('model_vram_large_v3')}"
                )
            else:
                self.model_guidance_text.set(
                    f"{self.tr('model_hint_large_v3_turbo')} / {self.tr('model_vram_large_v3_turbo')}"
                )
            return  # ← このインデントが重要

        if selected == "tiny":
            selected_label = self.tr("model_tiny_label")
            primary = self.tr("model_hint_tiny")
        elif selected == "small":
            selected_label = self.tr("model_small_label")
            primary = self.tr("model_hint_small")
        elif selected == "medium":
            selected_label = self.tr("model_medium_label")
            primary = self.tr("model_hint_medium")
        elif selected == "large":
            selected_label = self.tr("model_large_label")
            primary = self.tr("model_hint_large")
        else:
            selected_label = self.tr("model_base_label")
            primary = self.tr("model_hint_base_cpu")

        vram_key = f"model_vram_{selected.replace('-', '_')}"
        vram_text = self.tr(vram_key)

        combined = f"{self.tr('model_hint_selected', model=selected_label)} / {primary} / {vram_text}"
    ...
    def _startup_update_check(self):
        try:
            # 常に1回はチェック（通知用）
            self.check_for_updates(user_initiated=False, auto_apply=False)

            # 自動更新ONならダウンロードも
            if self.auto_update_enabled.get():
                self.check_for_updates(user_initiated=False, auto_apply=True)

        except Exception as e:
            self.log_exception("Startup update check failed", e)
        ...
        try:
            if hasattr(self, "btn_check_updates"):
                self.btn_check_updates.configure(
                    fg="#cbd5e1",
                    text=self.tr("update_button_short")
                )
        except Exception:
            pass

        self.check_for_updates(user_initiated=True, auto_apply=False)
    ...
    def _fetch_update_info(self):
        ...
        download_url = str(
            data.get("download_url") or data.get("url") or data.get("installer_url") or ""
        ).strip()
        return {
            "version": str(
        ...
        def runner():
            try:
                ...
                if version and self._is_newer_version(version):
                    ...
                    self.root.after(0, self._start_update_blink)
                    self.root.after(
                        0,
                        lambda: self.btn_check_updates.configure(text=self.tr("update_available_button")) if hasattr(self, "btn_check_updates") else None
                    )
                    ...
                    if info.get("mandatory") or user_initiated:
                        self.root.after(0, lambda: self._prompt_update_action(info))
                    elif auto_apply and self.auto_update_enabled.get():
                        self.root.after(
    ...
    def _start_update_blink(self):
        def blink():
            if not self.update_available:
                return

            self._update_blink_state = not self._update_blink_state
            color = "#ff9800" if self._update_blink_state else "#ffffff"

            try:
                if hasattr(self, "btn_check_updates"):
                    self.btn_check_updates.configure(
                        text=self.tr("update_available_button"),
                        fg=color,
                    )
            except Exception:
                pass
    ...
    def _prompt_update_action(self, info: dict):
        ...
        if notes:
            body += f"\n\n{notes}"
        body += "\n\n" + self.tr("update_confirm_install")
        if messagebox.askyesno(self.tr("update_title"), body):
    ...
    def download_and_apply_update(self, info: dict, silent: bool = False):
        ...
        def runner():
            try:
                filename = (
                    os.path.basename(download_url.split("?")[0]) or "VRCMisaTranslator_Pro_Update_Setup.exe"
                )
                dest = UPDATE_DOWNLOAD_DIR / filename
                UPDATE_DOWNLOAD_DIR.mkdir(parents=True, exist_ok=True)
                with urllib.request.urlopen(download_url, timeout=60) as response, open(
                    dest, "wb"
                ) as fh:
                ...
                self.root.after(0, lambda: self._launch_update_installer(dest, silent=silent))
            except Exception as exc:
                self.update_update_status_text(self.tr("update_error", error=str(exc)))
                if not silent:
                    self.root.after(
    ...
    def _launch_update_installer(self, installer_path: Path, silent: bool = False):
        if not installer_path.exists():
            messagebox.showerror(self.tr("error_title"), f"Update installer not found:\n{installer_path}")
            return
        if installer_path.suffix.lower() not in (".exe", ".msi"):
            self.update_update_status_text(self.tr("update_not_supported"))
            messagebox.showerror(
                self.tr("error_title"),
                f"Unsupported update package:\n{installer_path.name}"
            )
            return
        try:
    ...
    def save_blacklist_from_ui(self, raw_text=None):
        ...
        self.save_settings(write_log=False)
        self.save_blacklist_phrases_to_file()
    ...
    def load_settings(self):
        ...
        try:
            ...
            self.auto_update_enabled.set(
                bool(data.get("auto_update_enabled", self.auto_update_enabled.get()))
            )
            self.popup_suppressions = (
    ...
    def _build_ui(self):
        ...
        self.info_frame.grid(row=0, column=0, columnspan=2, sticky="ew", pady=(8, 8))
...
# model_cache_text row=0 column=3
        ttk.Label(
            self.info_frame,
...
# detected_device_text row=1 column=1
        ttk.Label(
            self.info_frame,
...
# model_guidance_text row=1 column=3
        ttk.Label(
            self.info_frame,
...
# translation_mode_status_text row=2 column=3
        ttk.Label(
            self.info_frame,
        ...
        self.label_model_status.grid(row=2, column=0, sticky="w", padx=(0, 4), pady=2)
# model_status_text row=2 column=1
        ttk.Label(
            self.info_frame,
        ...
        self.label_current_mode.grid(row=3, column=0, sticky="w", padx=(0, 4), pady=2)
# current_mode_text row=3 column=1
        ttk.Label(
            self.info_frame,
        ...
        self.label_processing_time.grid(
            row=3, column=2, sticky="w", padx=(16, 8), pady=2
        )
# processing_time_text row=3 column=3
        ...
        self.processing_time_value_label.grid(row=3, column=3, sticky="w", pady=2)
    ...
    def refresh_ui_language(self):
        ...
        if hasattr(self, "btn_check_updates"):
            self.btn_check_updates.configure(
                text=self.tr("update_available_button")
                if getattr(self, "update_available", False)
                else self.tr("update_button_short")
            )
        ...
        self.refresh_update_button_text()
    ...
    def normalize_model_value(self, value):
        ...
        if value in {
            ...
            return "large"
        if value in {
            self.tr("model_large_v3_label"),
            "large-v3",
        }:
            return "large-v3"

        if value in {
            self.tr("model_large_v3_turbo_label"),
            "large-v3-turbo",
        }:
    ...
    def get_model_display_label(self, model_name):
        display_map = {
            ...
            "large-v3": self.tr("model_large_v3_label"),
            "large-v3-turbo": self.tr("model_large_v3_turbo_label"),
        }
    ...
    def send_to_vrchat(self, text: str):
        if not text or not str(text).strip():
            self.log("Translation result empty. Skipped sending.")
            return
...
def _calibration_run(self):
    ...
    try:
        ...
        start_threshold = max(0.0035, noise_rms * 3.0, speech_rms * 0.14)
        start_threshold = min(max(start_threshold, 0.0035), 0.070)

        stop_threshold = max(0.0025, noise_rms * 1.8, start_threshold * 0.45)
        stop_threshold = min(
            max(stop_threshold, 0.0025), max(0.0025, start_threshold * 0.85)
        )

        silence_seconds = self._calibration_pick_silence_seconds(speech_rms, noise_rms)

        try:
            ratio = speech_rms / max(noise_rms, 1e-6)
            self.log(f"[CAL] noise={noise_rms:.6f} speech={speech_rms:.6f} ratio={ratio:.2f}")
        except Exception:
            pass
